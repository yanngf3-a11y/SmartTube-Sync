 ...
 *
 * NOTE: This class replaces the legacy
 * com.liskovsoft.smartyoutubetv2.ygsync.YgSyncDiscoveryServer.
 * It is owned exclusively by {@link SyncReceiverService}, which starts
 * it once at app startup (see MainApplication). It must not be
 * instantiated anywhere else (e.g. PlaybackActivity) to avoid two UDP
 * servers competing for the same port.
 */
public class SyncDiscoveryServer {

    public static final int DEFAULT_PORT = 8766;
    public static final int TCP_PORT = 8765;

    private static final String TAG =
            SyncDiscoveryServer.class.getSimpleName();
    ...
    public SyncDiscoveryServer(Context context) {
